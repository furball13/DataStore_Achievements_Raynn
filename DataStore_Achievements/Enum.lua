...
enum.AchievementCategories = {
	...
	ExpansionFeaturesDragonriderRacingWakingShores = -501,
	ExpansionFeaturesDragonriderRacingOhnaranPlains = -502,
	ExpansionFeaturesDragonriderRacingAzureSpan = -503,
	ExpansionFeaturesDragonriderRacingThaldraszus = -504,
	ExpansionFeaturesDragonriderRacingForbiddenReach = -505,
	ExpansionFeaturesDragonriderRacingZaralekCavern = -506,
	ExpansionFeaturesDragonriderRacingEmeraldDream = -507,
	ExpansionFeaturesDragonriderRacingKalimdorCup = -508,
	ExpansionFeaturesDragonriderRacingEasternKingdomsCup = -509,
	ExpansionFeaturesDragonriderRacingOutlandCup = -510,
	ExpansionFeaturesDragonriderRacingNorthrendCup = -511,
